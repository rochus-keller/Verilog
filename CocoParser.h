...
Vl::SynTree d_root;
	...
	void primary_2();
	void simple_or_deferred_or_property_immediate_assert_statement();
	void property_spec();
	void action_block();
	void simple_or_deferred_or_property_immediate_assume_statement();
	void simple_or_deferred_or_property_immediate_cover_statement();
