...
const char* SynTree::rToStr( quint16 r ) {
	switch(r) {
		...
		case R_assertion_item: return "assertion_item";
		...
		case R_comment_helper: return "comment_helper";
		...
		case R_edge_symbol: return "edge_symbol";
		...
		case R_immediate_assertion_statement: return "immediate_assertion_statement";
		...
		case R_library_text: return "library_text";
		...
		case R_module_instantiation: return "module_instantiation";
		...
		case R_next_state: return "next_state";
		...
		case R_source_text: return "source_text";
		...
		case R_udp_instantiation: return "udp_instantiation";
