...
namespace Vl {
	...
	struct SynTree {
		enum ParserRule {
			...
			R_comment_helper,
			R_concurrent_assertion_item,
			R_concurrent_or_immediate_assert_statement,
			R_concurrent_or_immediate_assume_statement,
			R_concurrent_or_immediate_cover_statement,
			...
			R_immediate_assertion_statement,
			R_include_statement,
			R_initial_construct,
			R_inout_declaration,
			R_input_declaration,
			...
			R_library_description,
			R_library_text,
			R_list_of_event_identifiers,
			R_list_of_net_decl_assignments_or_identifiers,
			R_list_of_parameter_assignments,
			R_list_of_port_connections,
			...
			R_module_instance,
			R_module_instance_identifier,
			R_module_instantiation,
			...
			R_name_of_module_instance,
			R_name_of_udp_instance,
			...
			R_next_state,
			R_number,
			R_ordered_or_named_port_connection,
			R_ordered_parameter_assignment,
