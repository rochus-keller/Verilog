...
namespace Vl {
	...
	struct SynTree {
		enum ParserRule {
			...
			R_simple_or_deferred_or_property_immediate_assert_statement,
			R_simple_or_deferred_or_property_immediate_assume_statement,
			R_simple_or_deferred_or_property_immediate_cover_statement,
